...
| `reports/` | `solution-plan.md` (why each capability was selected) and `solution-report.html` (a human readable view of the same blueprint, open it directly in a browser) |
